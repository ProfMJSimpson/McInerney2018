%% Figure2
% Author: Sean McInerney; Last Update: 14/06/18
%
...
% Set up background colours for Figure 2(a) and (c)
colour = [0.8275,0.5529,0.7176; 0.8745,0.8039,0.8784];

% Plot times
t_plot_a = [10,20,50,100,200,500,1000]; % For Figure 2(a)
t_plot_c = [10,200,500]; % For Figure 2(c)

% Parameters used for comparison in Figure 2(c)-(d)
D1 = [D1_hat,0.45];
D2 = [D2_hat,0.0077];

% Line colours in Figure 2(c)-(d)
