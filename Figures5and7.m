%% Figures5and7
% Author: Sean McInerney; Last Update: 21/06/18
%
% Corresponds to Figures 5 and 7
%
% Uses Figures3and4and6.m to generate data
% Ensure that parameters in Figures3and4and6 are appropriate and
...
%% Generate Data using Figures3and4and6.m
...
for ii = 1:length(PROBES)
    ...
    Figures3and4and6(p,q) % Generate data
end
...
if n2P > 0
    ...
    ylabel(axes7,'$\mathcal{A}_1$','Interpreter','Latex')
