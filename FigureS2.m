%% FigureS2
% Author: Sean McInerney; Last Update: 05/06/2018
%
...
% Initial time (Refer to Equation (47)-(48) in supplementary material)
T = zeros(N,1); % T is the numerical approximation to the temperature
T(1) = 1; % Dirichlet BC (Refer to Equation (49) in supplementary material)

% Construct A (Refer to Equations (57)-(59) in supplementary material)
...
while plot_count < nt
    ...
    % Iterate through time (Refer to Equation (56) in supplementary material)
