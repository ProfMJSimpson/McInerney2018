function Figures3and4and6( p , q )
%% Figures3and4and6
% Author: Sean McInerney; Last Update: 18/06/18
%
% Corresponds to Figures 3, 4 and 6
%
...
Npts = 21; % Npts = 2001 was selected in the paper
...
% Author: Sean McInerney; Last Update: 28/02/18
% Evaluates the Indicator Function.
%
% Refer to Equations (20) and (22) in the main document
% 
% FUNCTION INPUTS:
...
d = sum(abs(T_hat-T_test),2); % Refer to Equaion (19) in the main document
